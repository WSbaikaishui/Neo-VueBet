<template>
  <div style='padding:30px;'>
    ...
    <el-button @click="fetchPoolList">ceshi</el-button>
    <el-table
      v-loading="loading"
      :data='tableData'
      style='width: 100%'
    ...
    >
      ...
      <el-table-column
        ...
        <template slot-scope="scope" >
          ...
          <el-button  @click="isPayout(scope.row,1)"  size="primary"  plain>payout</el-button>
          <el-button @click="isCancel(scope.row,1)"  size="primary" type="danger" plain>cancel</el-button>
        </template>
      </el-table-column>
    </el-table>
